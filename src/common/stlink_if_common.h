...
typedef struct {
    ...
    uint8_t Jtag_Ver;  ///< Version for STM32 debug interface (JTAG and SWD
                       ///< protocols, Jx)
    uint8_t Msc_Ver;   ///< Version for mass storage and/or Virtual COM port
                       ///< interfaces (Mx)
...
} Stlk_VersionExtT, VERSION_EXT,
    *P_VERSION_EXT; // VERSION_EXT and *P_VERSION_EXT for legacy only
